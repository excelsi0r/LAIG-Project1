...
{ 
	...
	//Generate the texture coords by default with the max values
	var maxS = 1;
	var maxT = 1;
	this.updateTextureCoords(maxS,maxT);
 ...
 */
MyTriangle.prototype.updateTextureCoords = function (lentghS, lentghT) 
{
	...
	this.texCoords = [		      
			0, 1,
			c - a*cosBeta/lentghS,  1 - a*sinBeta/lentghT,
			c/lentghS,  1
	];
