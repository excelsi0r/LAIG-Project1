...
{	
	if(color == "yellow")
	{
		return this.createAppearence(this.scene, 0.4,0.4,0,1);		
	}
	else if(color == "red")
	{
		return this.createAppearence(this.scene, 0.3,0.05,0.05,1);
	}
	else if(color == "purple")
	{
		return this.createAppearence(this.scene, 0.2,0,0.5,1);
	}
	else if(color == "white")
	{
		return this.createAppearence(this.scene, 0.6,0.6,0.6,1);
	}
	else if(color == "blue")
	{
		return this.createAppearence(this.scene, 0,0.2,0.4,1);
	}
	else if(color == "green")
	{
		return this.createAppearence(this.scene, 0,0.2,0,1);
	}

};

MyFlower.prototype.createAppearence = function(scene, r, g, b, a)
{
	var emission = 0.03;
	var shininess = 0.1;
